...
<div class="container mt-auto">
    ...
    <a href="<?php echo site_url(INDEX_URL . 'barang/input'); ?>" class="btn btn-success mb-3"><i
            class="fa fa-plus"></i> Tambah Barang Baru</a>
    <hr>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form id="form-filter">
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6"> <label for="filter_nama_barang" class="sr-only">Nama
                            Barang:</label>
                        <input type="text" class="form-control" id="filter_nama_barang" name="filter_nama_barang"
                            placeholder="Nama Barang">
                    </div>
                    <div class="form-group col-xs-12 col-sm-6"> <label for="filter_kode_barang" class="sr-only">Kode
                            Barang:</label>
                        <input type="text" class="form-control" id="filter_kode_barang" name="filter_kode_barang"
                    ...
                    <div class="form-group col-xs-12 col-sm-6"> <label for="filter_penguasaan"
                            class="sr-only">Penguasaan:</label>
                        <input type="text" class="form-control" id="filter_penguasaan" name="filter_penguasaan"
                ...
                <div class="row">
                    <div class="col-xs-3 col-sm-3 mb-2">
                        <button type="button" id="btn-filter" class="btn btn-primary btn-block"><i
                                class="fa fa-filter"></i> Filter</button>
                    </div>
                    <div class="col-xs-3 col-sm-3 mb-2">
                        <button type="button" id="btn-reset" class="btn btn-default btn-block"><i
                                class="fa fa-refresh"></i> Reset</button>
                    </div>
                    <div class="col-xs-3 col-sm-3 mb-2">
                        <button type="button" id="btn-export-excel" class="btn btn-info btn-block"><i
                                class="fa fa-file-excel-o"></i> Export Excel Filtered</button>
                    </div>
                    <div class="col-xs-3 col-sm-3 mb-2">
                        <button id="exportPdfBtn" class="btn btn-danger btn-block"><i class="fa fa-file-pdf-o"></i>
                            Export PDF </button>
                    </div>
                </div>
            </form>
...
<div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="modal_form_label"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="ruangan_edit" name="ruangan_edit">
                                    ...
                                    <option value="<?= $ruangan1['lantai']; ?>-<?= $ruangan1['nama_ruangan']; ?>"
                                        <?= set_select('ruangan', $ruangan1['nama_ruangan']); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="penguasaan_edit" id="penguasaan_edit" placeholder="penguasaan_edit"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="jumlah_barang_edit" id="jumlah_barang_edit" placeholder="Jumlah"
