...
<div class="container">
        ...
        <select class="form-control" id="barang">
            ...
            <?php foreach ($barang_options as $barang): ?>
                <option value="<?= $barang['id']; ?>">
                    <?= $barang['kode_barang']; ?><?= $barang['NUP']; ?> - <?= $barang['nama_barang']; ?>- - <?= $barang['merk']; ?>
                </option>
            <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="kode_barang" name="kode_barang" value="<?= set_value('kode_barang'); ?>">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="jumlah_barang" name="jumlah_barang" value="<?= set_value('jumlah_barang'); ?>">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="tanggal_input" name="tanggal_input" value="<?= set_value('tanggal_input', $tanggal_default); ?>">
